      ...
      <div class="mt-5 single__property">
        ...
        <div style="gap: 10px" class="d-flex justify-content-center">
          <div class="register_button_wrap text-center mt-1 py-4">
            <span @click="edit_asset = !edit_asset" role="button" class="assets__link">
              <span class="px-3">Edit Property</span>
            </span>
          </div>

          <div class="register_button_wrap text-center mt-1 py-4">
            <span @click="$router.push(`/admin_dashboard/subscription_list/${id}`)" role="button" class="assets__link">
          ...
          <div class="change__password__form" v-show="edit_asset">
            <div class="password__modal slideInDown">
              <div class="text-right">
                <button style="font-size: 16px; font-weight: 600; color: #00e8fe" @click="edit_asset = !edit_asset">
                  x
                </button>
              </div>
              <div>
                <div class="form-group mx-2 mt-2">
                  ...
                  <input type="text" class="form-control" v-model="asset.current_market_price"
                    placeholder="Enter Price" />

                  <div class="register_button_wrap text-center mt-1 py-4">
                    <span @click="updateAsset()" role="button" class="assets__link">
