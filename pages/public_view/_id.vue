<template>
    <div class="w-100">
      <div class="public__property pr-3">
        <user-nav class="public__nav px-5 py-4" name="Property Details" />
        <div class="mt-5 single__property px-5">
          <div>
            <font-awesome-icon
              @click="back()"
              role="button"
  ...
  .public__property .asset__content {
  ...
  .public__property .asset__content p {
    opacity: 0;
  }
  .public__property .asset__content h4 {
    opacity: 0;
    color: #00e8fe;
  }
  .public__property .asset__content:hover {
    background-color: rgba(0, 0, 0, 0.34);
    background-blend-mode: overlay;
    z-index: 999;
  }
  .public__property .asset__content:hover p {
    opacity: 1;
    transition: ease-in-out 0.7s;
  }
  .public__property .asset__content:hover h4 {
    opacity: 1;
    transition: ease-in-out 0.7s;
  }
  .public__property .description__wrap p {
    line-height: 10px;
    font-weight: 500;
    font-size: 16px;
  }
  .public__property .description__wrap span {
    color: #00e8fe;
  }
  ...
  @media (max-width: 768px) {
    ...
    .public__property .description__wrap {
    ...
    .public__property .single__property {
